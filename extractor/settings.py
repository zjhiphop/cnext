...
__author__ = 'zjhiphop'
__license__ = 'MIT'
__copyright__ = 'Copyright 2019, zjhiphop'
...
DATA_DIRECTORY = '.extractor_scraper'

TOP_DIRECTORY = os.path.join(tempfile.gettempdir(), DATA_DIRECTORY)

# Error log
LOGFILE = os.path.join(TOP_DIRECTORY, 'extractor_errors_%s.log' % __version__)
MONITOR_LOGFILE = os.path.join(
    TOP_DIRECTORY, 'extractor_monitors_%s.log' % __version__)
